...
--SELECT * FROM notes WHERE title='7 things lady gaga has in common with cats';

--SELECT * FROM notes WHERE title LIKE '%%%%%%ways%%%%%%';

--UPDATE notes SET title='This is a new title Muhahahahah' AND content='THIS IS NEW CONTENT MUHAHAHAH' WHERE id=1;
